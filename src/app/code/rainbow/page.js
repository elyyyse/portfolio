  ...
  return (
    <div className={styles.gridWrapper}>
      ...
      <ol className={`${styles.ol} ${styles.bottomOl}`} start={3}>
        <li>
          And here comes the fun part, next you need to calculate the distance
          from the center of each dot to your cursor using the 🤗Pythagorean
          Theorem🤗. And that allows you to only affect dots that are a
          particular distance from the mouse.
        </li>
      </ol>
      <PlayableGif
